public class Lab10HashTableLinear
{
	int[] Table;
	int numOfCollisions = 0;
	int numOfOccupiedCells = 0;

	public Lab10HashTableLinear(int s)
	{
		int size = s + (s/3);
	...
	public int Rehash(int key, int i)
	{
		...
		System.out.println("Number Of Linear Probing Rehashes: " + numOfRehashes);
		return Rehash;
	}
